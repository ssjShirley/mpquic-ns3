...
do
    ...
    ./waf --run "scratch/mpquic-scheduler-bg-ndy.cc --Size=$1 --BVar=$BVar --BLambda=$BLambda --SchedulerType=${LOG} --Rate0=${RATE0} --Rate1=${RATE1} --Delay0=${DELAY0} --Delay1=${DELAY1} --LossRate=$LOSS" >$LOG1 2>$LOG2
